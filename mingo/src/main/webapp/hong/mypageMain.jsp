...
<body>
    ...
    <div class="board-wrapper2">
        ...
        <div class=" board-group shadow ml-4">
            ...
            <div class="form-group">
                <label for="re-pwd">비밀번호 확인:</label>
                <input type="password" class="form-control" id="re-pwd" style="width:50%;">
            </div>
            <div class="form-group">
                <label for="new-pwd">새 비밀번호:</label>
                <input type="password" class="form-control" id="new-pwd" style="width:50%;">
            </div>
