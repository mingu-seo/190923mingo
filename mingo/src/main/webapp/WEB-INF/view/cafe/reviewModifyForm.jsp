    ...
    <body>  
        ...
        <form action="modifyReview.do" method="post" enctype="multipart/form-data">
        	<div>
				...
				<input type="text" name="contents" value="${reviewVO.contents}"/>	
			</div>
        	<div>
				<label for = "taste_score">맛: </label>
				<input type="text" name="taste_score" value="${reviewVO.taste_score}"/>	
			</div>  
        	<div>
				<label for = "price_score">가격: </label>
				<input type="text" name="price_score" value="${reviewVO.price_score}"/>	
			</div>
        	<div>
				<label for = "service_score">서비스: </label>
				<input type="text" name="service_score" value="${reviewVO.service_score}"/>	
			</div>
        	<div>
				<label for = "wifi_score">와이파이 및 플러그: </label>
				<input type="text" name="wifi_score" value="${reviewVO.wifi_score}"/>	
			</div>
        	<div>
				<label for = "mood_score">시설 및 분위기: </label>
				<input type="text" name="mood_score" value="${reviewVO.mood_score}"/>	
			</div>
        	<div>
				<label for = "clean_score">청결도: </label>
				<input type="text" name="clean_score" value="${reviewVO.clean_score}"/>	
			</div>
        	<div>
				<label for = "image_file">카페 아이디: </label>
				<input type="file" name="image_file" value="${reviewVO.image}"/>	
			</div>
        	<div>
				<input type="submit" value="제출"/>	
			</div>
        	<div>
				<input type="text" name="user_id" value="${reviewVO.user_id }"/>	
				<input type="text" name="cafe_id" value="${reviewVO.cafe_id}"/>	
			</div>     
